      ...
      <div>
        ...
        <div className="mb-[3rem] flex items-center md:space-x-10">
          ...
          <p className="text-[19px] text-slate-300 w-[80%]">
            ...
            complex problems into simple, beautiful solutions. My background in
            design enhances my ability to build visually appealing interfaces
            while ensuring optimal performance and accessibility. I’m always
            eager to learn new technologies and collaborate on innovative
            projects.
          </p>
        </div>
